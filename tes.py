...
cel_fahrenheit = lambda x : (9/5 * x) + 32
cel_kelvin = lambda x : x + 273
...
def rumus(rm):
    ...
    hitungan = []
    def celcius():
        hitungan.append(cel_fahrenheit(conv)) if kotaksatu == "celcius" and kotakdua == "fahrentheit" else hitungan.append(cel_reamur(conv)) if kotaksatu == "celcius" and kotakdua == "reamur" else hitungan.append(cel_kelvin(conv)) if kotaksatu == "celcius" and kotakdua == "kelvin" else hitungan.append(nomer1)
    celcius()
...
cliked = StringVar()
cliked.set(option[0])
drop = OptionMenu(nwframe,cliked,*option)
drop.config(width=20)
drop.grid(row = 2,column=0)

cliked2 = StringVar()
cliked2.set(option[1])
drop2 = OptionMenu(nwframe,cliked2,*option)
drop2.config(width=20)
drop2.grid(row = 2,column=2)

#membuat tombol menghitung
btn = Button(nwframe,text="count",command=lambda:rumus("rumus"))
...
#     hitungan.append(cel_fahrenheit(conv)) if kotaksatu == "celcius" and kotakdua == "fahrentheit" else hitungan.append(cel_fahrenheit(conv)) if kotaksatu == "celcius" and kotakdua == "reamur" else hitungan.append(cel_kelvin(conv))
    ...
    #     hitungan = (4/5 * nomer1)
    # if kotaksatu == "fahrentheit" and kotakdua == "celcius":
